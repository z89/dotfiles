...
- **WM:** i3-gaps — config at `~/.config/i3/config`
- **Bar:** polybar — config at `~/.config/polybar/`
- **Launcher:** rofi — config at `~/.config/rofi/`
- **Compositor:** picom — config at `~/.config/picom/`
- **Notifications:** dunst — config at `~/.config/dunst/`
- **Display:** xrandr-managed (X11, not Wayland)
- **Colour scheme:** wpg/wal templates at `~/.config/wpg/templates/`
