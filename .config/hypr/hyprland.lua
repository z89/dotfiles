...
-- them for autoreload: that reload re-created the headless output and stalled the
-- shell mid-crossfade. theme-apply pushes the same colours live via hyprctl keywords.
