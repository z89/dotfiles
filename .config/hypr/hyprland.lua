...
-- Border/group colours are generated by DankMaterialShell (matugen) into ~/.config/hypr/dms/colors.lua
require("dms.colors")  -- ~/.config/hypr/dms/colors.lua, written by DankMaterialShell
require("borders")     -- ~/.config/hypr/borders.lua, matugen user template: neutral border colours
...
hl.animation({ leaf = "workspaces",    enabled = true, speed = 3.5, spring = "gentle",           style = "slide" })
